(function () {
  ...
  function injectEmbedModeStyles() {
    ...
    style.textContent = [
      ...
      "html.is-embed-mode .variant-sublabel,",
      "html.is-embed-mode .preview-label {",
      "  display: none !important;",
      "}",
      /* Upgrade desktop: hide static-state sections + extra chrome around catalog-row */
      "html.is-embed-mode .subrow,",
      "html.is-embed-mode .btn-row {",
      "  display: none !important;",
      "}",
      "html.is-embed-mode .catalog-row {",
      "  padding: 0 !important;",
      "  margin: 0 !important;",
      "  gap: 0 !important;",
      "  justify-content: flex-start !important;",
      "}",
      "html.is-embed-mode .variant-slot {",
      "  gap: 0 !important;",
      "  padding: 0 !important;",
      "}"
    ].join("\n");
